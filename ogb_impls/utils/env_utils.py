...
import ogbench
from ogb_impls.utils.datasets import Dataset
...
def make_env_and_datasets(dataset_name, dataset_path=None, env_only=False):
    ...
    if env_only:
        ...
        env, train_dataset, val_dataset = ogbench.make_env_and_datasets(
            dataset_name, compact_dataset=True, dataset_path=dataset_path
        )
