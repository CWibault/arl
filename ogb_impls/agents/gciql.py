...
from ogb_impls.utils.networks import GCActor, GCValue
...
class GCIQLAgent(flax.struct.PyTreeNode):
    ...
    def actor_loss(self, batch, grad_params, rng=None):
        ...
        if self.config["actor_loss"] == "awr":
            ...
            bc_loss = -(self.config["ddpgbc_alpha"] * log_prob).mean()
    ...
    def create(
        ...
        ex_goals = ex_batch["observations"]
...
def get_config():
    config = ml_collections.ConfigDict(
        dict(
            ...
            awr_alpha=3.0,  # AWR temperature.
            ddpgbc_alpha=1.0,  # DDPG+BC temperature.
            actor_const_std=True,  # Whether to use constant standard deviation for the actor.
